MRI Core version 3.0.0 is now available from:
...
**GUI** - Conversion from zPIV to PIV can be done using the `Privacy Dialog` in the QT wallet. Enter a MRI address that you would like to Pay To, enter the amount of PIV the receiver should be sent, click `Spend Zerocoin`.
...
### Broad Features
- #264 `15e84e5` zPIV is here! (Fuzzbawls Mrs-X Presstab Spock MRI)
