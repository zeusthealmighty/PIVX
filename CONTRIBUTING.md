Contributing to MRI Core
============================

The MRI Core project operates an open contributor model where anyone is
...
the pull request affects. Valid areas as:
  ...
  - *Tests* for changes to the mirai unit tests or QA tests
...
The following applies to code changes to the MRI Core project, and is not to be
confused with overall MRI Network Protocol consensus changes.

Whether a pull request is merged into MRI Core rests with the project merge
...
Patches that change MRI consensus rules are considerably more involved than
...
Where a patch set proposes to change the MRI consensus, it must have been
...
The project leader is the release manager for each MRI Core release.
