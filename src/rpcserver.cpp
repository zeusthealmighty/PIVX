...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"mirai", "listmasternodes", &listmasternodes, true, true, false},
        {"mirai", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mirai", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mirai", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mirai", "masternodedebug", &masternodedebug, true, true, false},
        {"mirai", "startmasternode", &startmasternode, true, true, false},
        {"mirai", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mirai", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mirai", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mirai", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mirai", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mirai", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mirai", "mnbudget", &mnbudget, true, true, false},
        {"mirai", "preparebudget", &preparebudget, true, true, false},
        {"mirai", "submitbudget", &submitbudget, true, true, false},
        {"mirai", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mirai", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mirai", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mirai", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mirai", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mirai", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mirai", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mirai", "checkbudgets", &checkbudgets, true, true, false},
        {"mirai", "mnsync", &mnsync, true, true, false},
        {"mirai", "spork", &spork, true, true, false},
        {"mirai", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mirai", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
