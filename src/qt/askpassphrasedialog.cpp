                                                                                                            ...
                                                                                                            fCapsLock(false)
{
    ...
    if (context == Context::Unlock_Menu || context == Context::Mint_zMRI || context == Context::BIP_38) {
    ...
    // It doesn't make sense to show the checkbox for sending MRI because you wouldn't check it anyway.
    if (context == Context::Send_MRI || context == Context::Send_zMRI) {
