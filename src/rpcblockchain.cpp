...
UniValue blockToJSON(const CBlock& block, const CBlockIndex* blockindex, bool txDetails = false)
{
    ...
    result.push_back(Pair("zMRIsupply", zpivObj));
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zMRIsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zMRI denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zMRI denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zMRI denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zMRI denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zMRI denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zMRI denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zMRI denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zMRI denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zMRI denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
